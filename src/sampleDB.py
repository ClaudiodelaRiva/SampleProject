...
'''
Ejemplos básicos de acceso a una base de datos sqlite
...
#Ejemplo básico, parte 2, consultas con parámetros
...
def example3Dates ():
    ...
    try: 
        ...
        for row in res:
            ...
            month = fecha.month
            day = fecha.day
            print ("example3Dates:",fecha,"Anio: ", year,"Mes: ", month,"Dia:", day)            
...
#Ejecuta el script nameFile sobre la base de datos de nombre dbName
def ejecutaScript (dbName,nameFile): 
...
def example5Otras ():
    DATABASE = "CompanyDB.db"
    ejecutaScript(DATABASE,"resources/schema.sql") #Crea el esquema
    ejecutaScript(DATABASE,"resources/data.sql") #Carga incial de datos
    try: 
        conn = sqlite3.connect(DATABASE)
        curs = conn.cursor() 
        ...
        # UPDATE - Actualización de salario 10% de los empleados que tienen salario inferior a 2000
